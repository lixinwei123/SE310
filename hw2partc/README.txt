PART D MATERIAL:
Created by Kevin Li(kl958) on November, 2019 for SE310, hw2 part D
Foremost, ranking inherits from matching since many of the functionalities are same.

Everything is the same but I addressed this assignment's criteria. I have implemented a ranking option where the user can rank, and have added it to
take a survey/test, modify survey/test, tabulate a survey/test, create a survey/test as well.

For output/input, everything has been with abstraction since part B, where I have two classes, Output and Input that takes care of the process of
getting user input, printing out user input as well serialization and de-serialization.
----------------------------------------------------------------------------------------------------------------------
PART C MATERIAL:
